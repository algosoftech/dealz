...
class Admin_model extends CI_Model
{
	...
	************************************************************************/
	function getDepartment($departmentId='')
	{
		...
		$result = $this->mongo_db->get('da_admin_department');
		if($result):	
			foreach($result as $info):
	...
	************************************************************************/
	function getDesignation($designationId='')
	{
		...
		$result = $this->mongo_db->get('da_admin_designation');
		if($result):	
			foreach($result as $info):
	...
	************************************************************************/
	function getEmirates($emirateId='')
	{
		...
		$result = $this->mongo_db->get('da_emirate');
		if($result):	
			foreach($result as $info):
	...
	************************************************************************/
	function getEmiratesArea($emirateId='',$area_id='')
	{
		...
		$result = $this->mongo_db->get('da_area');
