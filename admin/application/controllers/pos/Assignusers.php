...
class Assignusers extends CI_Controller {
	...
	{	
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('All assign User List | POS | Dealz Arabia');
	...
	{		
		...
		$data['salesPerson'] = $this->common_model->getDataByNewQuery($fields,'multiple','da_users',$where,$shortField);
