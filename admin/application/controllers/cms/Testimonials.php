...
class Testimonials extends CI_Controller {
	...
	{	
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Term & Conditions | CMS | Dealz Arabia');
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']				=	$this->common_model->getDataByParticularField('da_cms','testimonial_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')):
			...
			if($this->input->post('CurrentDataID') ==''):
				...
				$this->common_model->editData('da_cms',$param,'testimonial_id',(int)$SEQId);
	...
	{  
		...
		$this->common_model->editData('da_cms',$param,'testimonial_id',(int)$changeStatusId);
	...
	{  	
		...
		if($deleteId):
			$this->admin_model->authCheck('edit_data');
			$data			=	$this->common_model->getDataByParticularField('da_cms','testimonial_id',(int)$deleteId);
		...
		$this->common_model->deleteData('da_cms','testimonial_id',(int)$deleteId);
	...
	************************************************************************/
	...
	{  
		...
		if($imageName):
			...
			$this->common_model->editData('da_cms',$param,'testimonial_id',(int)$id);
		endif;
		if($typ == 'web'):
