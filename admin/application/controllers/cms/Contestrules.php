...
class contestrules extends CI_Controller {
	...
	public function index()
	{
       ...
       if ($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Contest Rules | CMS | Dealz Arabia');
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']		=	$this->common_model->getDataByParticularField('da_cms','contestrules_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')): 
			...
			if($this->form_validation->run() && $error == 'NO'):  
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['contestrules_id']		=	(int)$this->common_model->getNextSequence('da_cms');
					...
					$this->common_model->editData('da_cms',$param,'contestrules_id',(int)$NotificationTempId);
		...
		$this->layouts->set_title('Add/Edit Contest Rules | CMS | Dealz Arabia');
	...
	{  
		...
		$this->common_model->editData('da_cms',$param,'contestrules_id',(int)$changeStatusId);
