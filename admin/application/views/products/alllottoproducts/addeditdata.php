...
<div class="pcoded-main-container">
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><?=$EDITDATA?'Edit':'Add'?> Lotto Product</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="form-group-inner col-lg-3 col-md-3 col-sm-3 col-xs-12 <?php if(form_error('product_image')): ?>error<?php endif; ?>">
                        ...
                        <?php if($EDITDATA['product_image']): ?>
                         <div id="ImageDiv2"><img src="<?php echo fileBaseUrl.$EDITDATA['product_image']; ?>" width="50" border="0" alt="">&nbsp;
                             <a href="javascript:void(0);" onclick="ImageDelete('<?php echo $EDITDATA['product_image']; ?>','<?php echo $EDITDATA['products_id']; ?>','app');"> 
                ...
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-4 col-xs-12 <?php if(form_error('product_image_alt')): ?>error<?php endif; ?>">
                ...
                <div class="form-group-inner col-lg-3 col-md-3 col-sm-3 col-xs-12 <?php if(form_error('target_stock')): ?>error<?php endif; ?>">
         ...
         <div class="row">
            ...
            <div class="form-group-inner col-lg-3 col-md-3 col-sm-3 col-xs-12 <?php if(form_error('stock')): ?>error<?php endif; ?>">
            ...
            <div class="form-group-inner col-lg-3 col-md-3 col-sm-3 col-xs-12 <?php if(form_error('lotto_range')): ?>error<?php endif; ?>">
                <label>Number Range<span class="required">*</span></label>
                <input type="number" min="1"  max="100" name="lotto_range" id="lotto_range" class="form-control required" value="<?php if(set_value('lotto_range')): echo set_value('lotto_range'); elseif($EDITDATA['lotto_range']): echo stripslashes($EDITDATA['lotto_range']); endif; ?>" >
                <div class="range-section"></div>
                <?php if(form_error('lotto_range')): ?>
                    <span for="lotto_range" generated="true" class="help-inline"><?php echo form_error('lotto_range'); ?></span>
                <?php endif; ?>
            </div>
        </div>
