                ...
                <form id="Data_Form" name="Data_Form" method="get" action="<?php echo $forAction; ?>">
                  <div class="dt-responsive table-responsive">
                    ...
                    <th width="10%" style="text-align: right;">Status</th>
                      ...
                      <td><a href="<?php echo getCurrentControllerPath('getAllusers/'.$ALLDATAINFO['products_id'])?>"><?=substr($ALLDATAINFO['products_id'], -5)?></a></td>
                      ...
                      <td style="text-align: right;"><?=showStatus($ALLDATAINFO['status'])?></td>
                          ...
                          <li><a href="<?php echo base_url('winners/allsawinners/index/'.base64_encode($ALLDATAINFO['products_id']))?>"><i class="fas fa-trophy"></i> Add Winners</a></li>
                          <li><a href="<?php echo base_url('tickets/allsatickets/index/'.base64_encode($ALLDATAINFO['products_id']))?>"><i class="fas fa-trophy"></i> Add Ticket</a></li>
