...
public function  __construct() 
	...
	************************************************************************/ 		
	public function ngenius_order_status()
	{
		...
		$outletID = "e72708e2-8658-4b91-a1e1-047990aba51a";
		$orderRef    = $this->input->get('ref');
		$url = 'https://api-gateway.ngenius-payments.com/transactions/outlets/'.$outletID.'/orders/'.$orderRef;
		$curl = curl_init();
