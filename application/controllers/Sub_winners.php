...
{  
	...
	$data["winner_list"] = $this->getWinnerList($code, $order_id, $offset, $limit, $perpage);
...
public function getWinnerListByAjax(){
	...
	if($this->input->post()){
		...
		$result = $this->getWinnerList($code, $order_id, $newoffset, $limit, $perpage, $code);
...
public function getWinnerList($code = '', $order_id = '', $offset=0, $limit=10, $perpage=0){
