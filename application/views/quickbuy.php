...
/*        padding: 20px 7.5px !important;*/
    ...
    .quick-buy-container .menu_inner{
        text-align: right;
        margin: 20px;
    }

    .quick-buy-container .quick-buy-link {
        margin: auto 6px;
        text-decoration: none;
        color: #000000;
    }

    .quick-buy-container .icofont-share:before {
        content: "\efe5";
        line-height: 28px;
    }

    .quick-buy-container .buy_voucher{
        background-color : #C92620;
        color: #fff;
    }

    .deailboxbtns a.buy_product {
        background-color : #E8E2E2;
        color:#000
    }

    @media only screen and (min-width:768px){
        .quick-buy-container .pod_imgpop .pod_imgpopbox {
            width:40% !important;
        }

        .quick-buy-container section.deals_homesec {
            width: 75%;
            margin: auto;
        }
    }
