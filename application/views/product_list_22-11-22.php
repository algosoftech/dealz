						...
						<div class="col-lg-7 col-md-7 col-12 heart">
							...
							<div class="heaarts">
								...
								<?php 
									...
									<?php else: ?>
										<a href="javascript:void(0);" class="share"><i class="far fa-share" title="Share Campaigns" ></i></a>
									<?php endif; ?>
								<?php else: ?>
									<a href="javascript:void(0);" class="share userLoginError"><i class="far fa-share" title="Share Campaigns" ></i></a>
								<?php endif; ?>
							</div>
						</div>
					</div>
