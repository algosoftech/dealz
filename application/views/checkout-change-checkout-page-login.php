      ...
      <div class="card">
        <select name="address" id="address" style="width: 100%;">
          <?php foreach ($dilivertAddress as $key=> $da) { ?>
            <option value="<?=$da['id']?>_____<?=$da['village']?>, <?=$da['street']?>, <?=$da['area']?>, <?=$da['city']?> <?=$da['country']?>, <?=$da['pincode']?>"> <?=$da['village']?> <?=$da['street']?> <?=$da['area']?> <?=$da['city']?> <?=$da['country']?><!-- <address>
          Adam Johnson<br />
    ...
    <div>
      ...
      <table>
		...
		<td><h2 style="color: black;">Total</h2></td>
          ...
          <td style="padding: 17px 0px;">  Inclusice of VAT</td>
