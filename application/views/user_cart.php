...
.user_profile ,.my-profile .users_members{
...
<div class="my-profile user_Cart">
	<div class="container">
		<div class="row">
													...
													<tr>
														<td width="50%">
															<div class="cart-product">
																<img src="<?=base_url().$items['other']['image']?>" class="img-fluid" alt="user_cart_product">
															</div>
														</td>
														<td width="50%">
															<div class="table-hd">
																<h3><?=$items['name']?></h3>
																<h5><?=stripslashes($items['other']['description'])?></h5>
															</div>
...
<script>
	$(document).ready(function(){
		$('.qtyA').click(function(){
			...
			var ur = '<?=base_url()?>';
			var totalID = param.split("___");
			$.ajax({
				url : ur+ "shopping_cart/addqty/"+param,
				method: "POST", 
				data: {data: param},
				success: function(data3){
					
					var totalVAL = data3.split("__");
