                        ...
                        <div class="user_list" style="overflow-x: auto;">
                          <table>
                            <tr>
                              ...
                              <th style="text-align:Left;">Product List</th>
                             
                              <th style="text-align:Left;">Collection Point</th>
                              <th style="text-align:Left;">Pick Up Point</th>
                              <th style="text-align:Left;">Purchase Date</th>
                              <th style="text-align:Left;">Total Amount</th>
                              <th style="text-align:Left;">Collection Code</th>
                            ...
                            <tr>
                              ...
                              <td width="20%" style="text-align: left;"><?php 
                                ...
                                foreach ($items['order_details'] as $key => $v):
                                    echo $j.'. '.stripslashes($v['product_name']).'<br>';  
                                    $j++;
                                endforeach;
                              ?></td>
                              <!-- <td width="10%"><?=$ordDetails['quantity']?></td> -->
                              ...
                              <td width="20%">AED <?=number_format($items['total_price'],2)?></td>
                              <td width="15%">
                                <b id="collectionCode<?=$i?>" class="collectionCode"  data-seq="<?=$i?>" style="display:none;"><?php echo base64_decode($items['collection_code']) ?></b>
                                <a id="showCollectionCode<?=$i?>" class="showCollectionCode" data-seq="<?=$i?>" href="javaScript:void{0}"><i class="fa fa-eye" style="font-size: 23px;"></i></a>
                                <a id="hideCollectionCode<?=$i?>" class="hideCollectionCode" data-seq="<?=$i?>" style="display:none" href="javaScript:void{0}"><i class="fa fa-eye-slash" style="font-size: 23px;"></i></a>
                              </td>
                              <td>
...
<script>
    $('.showCollectionCode').click(function(event){
        var a = $(this).data('seq');
        $('#collectionCode'+a).css('display','block');
        $('#showCollectionCode'+a).css('display','none');
        $('#hideCollectionCode'+a).css('display','block');
    });
    $('.hideCollectionCode').click(function(){
        var a = $(this).data('seq');
        $('#collectionCode'+a).css('display','none');
        $('#hideCollectionCode'+a).css('display','none');
        $('#showCollectionCode'+a).css('display','block');
    });
</script>
    <script>
