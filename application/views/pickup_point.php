					...
					<div class="user-earningblock">
						...
						<div class="user_list" style="overflow-x: auto;">
						  <table>
						    ...
						    <tr>
						      <td width="7%"><?=$i?></td>
						      <td width="20%"><?=$items['emirate_name']?></td>
						      <td width="20%"><?=$items['area_name']?></td>
						      <td width="25%"><?=$items['collection_point_name']?></td>
                              <td width="10%"><a href="<?=base_url('product-request/'.base64_encode($items['collection_point_id']))?>">View</a></td>
                              <td width="10%"><a href="<?=base_url('stock-report/'.base64_encode($items['collection_point_id']))?>">View</a></td>
						      <td width="25%"><?=date('d M Y', $items['creation_date'])?></td>
						      <!-- <td>
