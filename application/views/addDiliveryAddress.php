		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="users_form">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
							  <input type="text" name="village" id="village" value="<?php if(set_value('village')): echo set_value('village'); endif; ?>" placeholder="Villa/Flat No" class=" <?php if(form_error('village')): ?>error<?php endif; ?>">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon" style="margin-right:0px;">
							  <input type="text" name="street" value="<?php if(set_value('street')): echo set_value('street'); endif; ?>" placeholder="Floor /Door No" class=" <?php if(form_error('street')): ?>error<?php endif; ?>">
						 	 <i class="fal fa-city"></i>
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
						  ...
						  <?php */ ?>
						  <?php if(set_value('country')): $country = set_value('country'); else: $country = 'United Arab Emirates'; endif; ?>
