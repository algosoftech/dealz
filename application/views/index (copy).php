						...
						<div class="item">
							<div class="slide-product-box">
								...
								<div class="product-des">
									...
									<p>Max Draw Date : <?=date('d-M-Y', strtotime($items['draw_date']))?></p>
...
<div class="explore-campaign">
	<div class="container">
		...
		<div class="row">
			<?php if($products){ foreach ($products as $key => $item) {
					...
					<div class="row">
						...
						<div class="col-lg-7 col-md-7 col-12 heart">
							...
							<p><?=substr(strip_tags($item['description']),0,100)?>...</p>
								...
								<p>Max Draw Date : <?=date('d-M-Y', strtotime($item['draw_date']))?></p>
							</div>
							<div class="hearts">
					...
					<div class="action-block">
						<div class="row">
							...
							<div class="col-lg-3 col-md-3 col-12">
								...
								<h2 class="textes" style="left:58px !important;">Sold</h2>
							</div>
							<?php }?>
						</div>
					</div>
			...
			<div class="col-lg-12 col-12">
				...
				<div class="owl-slider">
					<div id="sold-out" class="owl-carousel">
						<?php if($outOfStock){ foreach ($outOfStock as $key => $oos) { ?>
						<div class="item">
