						...
						<div class="user_list" style="overflow-x: auto;">
						  <table>
						    ...
						    <tr>
						      ...
						      <td width="20%"><?php echo $ordDetails['product_name'];  ?></td>
						      <td width="10%"><?=$ordDetails['quantity']?></td>
						      <td width="45%"><?=$items['emirate_name'].'<br>'.$items['collection_point_name']?></td>
						      <td width="15%"><?=date('d M Y', strtotime($items['created_at']))?></td>
						      <td width="10%">AED<?=number_format($items['total_price'],2)?></td>
						      <td>
